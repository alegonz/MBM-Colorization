...
def build_gmd_log_likelihood(input_shape, m):
    ...
    def _gmd_log_likelihood(y_true, y_pred):
        ...
        Args:
            ...
            y_pred (tensor): Tensor of shape (samples, m*(height*width*2 + 2)), where m is the number of gaussians.
                ...
                3) m*height*width means (outputs of a linear activation layer)

        Returns:
            Average negative log-likelihood of each sample.
        """
        height, width = input_shape
        splits = [m, m, m*height*width*2]
        ...
        c = height*width  # Number of output dimensions
